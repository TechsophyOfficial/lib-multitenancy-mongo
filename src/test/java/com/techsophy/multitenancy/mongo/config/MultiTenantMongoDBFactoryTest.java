...
class MultiTenantMongoDBFactoryTest{
    ...
    void SimpleMongoClientDatabaseFactoryTest(){
        ...
        Assertions.assertEquals(simpleMongoClientDatabaseFactory.getMongoDatabase(),new SimpleMongoClientDatabaseFactory(mongoClient,"abc").getMongoDatabase());
    }
